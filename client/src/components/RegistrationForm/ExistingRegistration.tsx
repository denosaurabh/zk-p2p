          ...
          {!isLoggedIn ? (
            <ErrorContainer>
              <ThemedText.DeprecatedBody textAlign="center">
                ...
                <div>Your Venmo registration will appear here.</div>
            ...
            <Body>
              <NumberedInputContainer>
                <NumberedStep>{REGISTRATION_INSTRUCTIONS}</NumberedStep>
              </NumberedInputContainer>
              <ReadOnlyInput
              ...
              />
              {isRegistered ? (
                <ReadOnlyInput label="Venmo Profile" value={registrationHash} />
              ) : (
                <Button onClick={handleNewRegistrationClick} height={40}>
                  Create Registration
                </Button>
